export interface NoteProps {
  id: string; userId: string; spaceId: string | null; folderId: string | null
...
export class Note {
  ...
  toDTO(): NoteDTO {
    return { id: this.props.id, userId: this.props.userId, spaceId: this.props.spaceId, folderId: this.props.folderId,
