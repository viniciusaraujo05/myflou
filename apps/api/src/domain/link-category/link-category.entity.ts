export interface LinkCategoryProps { id: string; userId: string; name: string; color: string; createdAt: Date; updatedAt: Date }
export interface LinkCategoryDTO { id: string; userId: string; name: string; color: string; createdAt: string; updatedAt: string }
